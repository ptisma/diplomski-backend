...
type IPredictedMicroclimateReadingRepository interface {
	GetMicroClimateReadings(microclimateID, locationID int, fromDate, toDate time.Time) ([]models.PredictedMicroclimateReading, error)
	GetLatestMicroClimateReading(locationID int) (models.PredictedMicroclimateReading, error)
