...
type IBackgroundContainer interface {
...
func (s *scheduler) ScheduleBackgroundWorks() {
	...
	log.Println("launched all background goroutines")
}
...
func GetBackgroundContainer(ctx context.Context, worker BackgroundWorker) IBackgroundContainer {
	if k == nil {
...
//}
//
//func NewBackground(app application.Application) Background {
//	return &background{
